/* =========================================================================
   DRAG & SHOT — translation dictionary
...
window.TS_I18N = {
  ...
  ko: {
    ...
    hero: {
      ...
      sub: "벽에 튕기고 장애물을 넘어, 불가능해 보이는 슛에 도전하세요!<br>짜릿한 Drag & Shot의 재미를 경험해 보세요.",
      ctaPlay: "맵 보기",
      ctaDownload: "지금 바로 다운로드",
    },
    features: {
      title: "매 스테이지마다 펼쳐지는 새로운 도전",
      desc: "수십 가지의 개성 넘치는 스테이지와 다양한 장애물들이 기다립니다.<br>창의적인 플레이로 당신만의 Drag & Shot을 완성해보세요.",
    },
    gallery: {
      prev: "이전 화면",
      next: "다음 화면",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "점수를 획득하려면 어떻게 해야 하나요?", a: "점수는 다양한 상황에서 획득할 수 있습니다. 깔끔한 슛을 성공시키거나, 강한 파워로 공을 던지거나, 장애물과 상호작용하면 추가 점수를 얻을 수 있습니다. 최고의 Drag & Shot으로 높은 점수에 도전해 보세요." },
    ...
    download: {
      title: "지금 바로 다운로드하세요",
      desc: "무료로 다운로드하고 지금 바로 Drag & Shot에 도전해 보세요.",
    ...
    privacy: {
      title: "개인정보 처리방침",
      subtitle: "Drag & Shot: Basketball Arcade가 어떤 정보를 수집하고 어떻게 사용하는지 안내합니다.",
      back: "홈으로 돌아가기",
      updated: "최종 수정일: 2026년 7월 20일",
      sections: [
        { h: "1. 개요", body: "<p>라온픽셀즈(LaonPixels, 이하 &#8216;개발자&#8217;)는 자사가 제공하는 모바일 게임 Drag & Shot: Basketball Arcade(이하 &#8216;앱&#8217;) 이용자의 개인정보를 소중히 여기며 관련 법령을 준수합니다. 본 방침은 앱 이용 과정에서 개인정보가 어떻게 처리되는지 안내합니다.</p>" },
        { h: "2. 수집하는 정보", body: "<p>Drag & Shot: Basketball Arcade는 최소한의 정보만을 수집합니다.</p><ul><li><strong>기기 저장 정보:</strong> 스테이지 클리어 여부, 별점 기록 등 게임 진행 상황은 기기 내부에만 저장되며 개발자의 서버로 전송되지 않습니다.</li><li><strong>광고 관련 정보:</strong> 앱은 Google AdMob 광고 서비스를 이용하며, 광고 게재 및 성과 측정을 위해 광고 식별자(Advertising ID), 기기 ID, 대략적인 위치(IP 주소 기반), 기기 정보, 앱 이용·상호작용 정보, 진단 정보(충돌·실적 데이터) 등이 Google 및 그 광고 파트너에 의해 수집·처리될 수 있습니다.</li><li><strong>문의 정보(선택):</strong> 고객 문의 시 이메일 주소 및 문의 내용</li></ul>" },
        { h: "3. 정보의 이용 목적", body: "<ul><li>게임 진행 상황 저장 및 복원</li><li>앱 오류 개선 및 서비스 품질 향상</li><li>앱 내 광고 게재 및 광고 성과 측정</li><li>고객 문의 응대</li></ul>" },
        { h: "4. 정보의 공유 및 제3자 제공", body: "<p>개발자는 이용자의 개인정보를 제3자에게 판매하지 않습니다. 게임 진행 데이터는 기기 내에 로컬로 저장되며 개발자의 서버로 전송되지 않습니다.</p><p>다만 앱은 광고 게재를 위해 Google AdMob을 이용하며, 이 과정에서 위 &#8216;수집하는 정보&#8217;에 명시된 광고 관련 정보가 Google 및 그 광고 파트너에게 제공·처리됩니다. Google의 데이터 처리에 관한 자세한 내용은 아래 링크를 참고해 주세요.</p><ul><li>Google 광고 및 개인정보: <a href=\"https://policies.google.com/technologies/partner-sites\" target=\"_blank\" rel=\"noopener\">policies.google.com/technologies/partner-sites</a></li></ul>" },
        { h: "5. 데이터 보관 기간", body: "<p>게임 진행 데이터는 이용자가 앱을 삭제할 때까지 기기에 보관됩니다. 앱 삭제 시 모든 로컬 데이터가 함께 삭제됩니다. 고객 문의 기록은 응대 완료 후 1년 이내에 파기됩니다.</p>" },
        { h: "6. 아동의 개인정보", body: "<p>본 앱은 만 13세 이상 이용자를 대상으로 제공됩니다. 개발자는 만 13세 미만 아동의 개인정보를 고의로 수집하지 않으며, 앱은 별도의 계정 생성이나 개인정보 입력을 요구하지 않습니다.</p><p>다만 앱 내 광고(Google AdMob)가 표시되므로, 어린 이용자는 보호자의 지도 하에 이용하시길 권장합니다. 만 13세 미만 아동의 개인정보가 수집된 사실을 알게 된 경우, 개발자는 이를 지체 없이 삭제합니다.</p>" },
        ...
        { h: "9. 문의처", body: "<p>개인정보 관련 문의는 아래로 연락해 주시기 바랍니다.</p><p><strong>개발자:</strong> LaonPixels<br><strong>이메일:</strong> laonpixels@gmail.com</p>" },
      ],
    },
    terms: {
      title: "이용약관",
      subtitle: "Drag & Shot: Basketball Arcade 이용에 관한 약관입니다.",
      back: "홈으로 돌아가기",
      updated: "최종 수정일: 2026년 7월 20일",
      sections: [
        { h: "1. 목적 및 약관의 동의", body: "<p>본 약관은 LaonPixels(이하 &#8216;운영자&#8217;)가 제공하는 모바일 게임 Drag & Shot: Basketball Arcade(이하 &#8216;앱&#8217;)의 이용과 관련하여 운영자와 이용자 간의 권리, 의무 및 책임 사항을 규정함을 목적으로 합니다. 이용자가 앱을 다운로드, 설치 또는 이용하는 경우 본 약관에 동의한 것으로 간주됩니다. 본 약관에 동의하지 않는 경우 앱의 이용을 중단하고 이를 삭제해 주시기 바랍니다.</p>" },
        ...
        { h: "3. 서비스의 내용", body: "<p>Drag & Shot: Basketball Arcade는 물리 기반의 원터치 농구 Drag & Shot 퍼즐 게임입니다. 운영자는 서비스 품질 향상을 위하여 게임 콘텐츠(스테이지, 맵, 기능 등)를 추가하거나 변경할 수 있습니다.</p>" },
        ...
        { h: "7. 결제 및 환불", body: "<p>Drag & Shot: Basketball Arcade는 현재 무료로 제공됩니다. 추후 인앱 결제 또는 유료 콘텐츠가 도입되는 경우, 결제·청약철회·환불은 전자상거래 등에서의 소비자보호에 관한 법률 등 관련 법령과 결제가 이루어진 앱 마켓(App Store, Google Play 등)의 환불 정책에 따릅니다.</p><p>관련 법령에 따라 보장되는 이용자의 청약철회 및 환불 권리는 본 약관에 의해 제한되지 않습니다.</p>" },
        ...
        { h: "10. 미성년자의 이용", body: "<p>본 앱은 별도의 계정 생성이나 개인정보 입력 없이 이용할 수 있으며, 만 13세 이상 이용자를 대상으로 제공됩니다. 만 13세 미만 아동이 이용하는 경우 법정대리인의 지도 하에 이용할 것을 권장합니다. 추후 유료 결제 기능이 도입될 경우, 미성년자의 결제는 법정대리인의 동의를 받아야 하며, 동의를 받지 못한 결제는 관련 법령에 따라 미성년자 본인 또는 법정대리인이 취소할 수 있습니다.</p>" },
    ...
    patch: {
      title: "패치 노트",
      subtitle: "Drag & Shot의 최신 업데이트 소식을 확인하세요.",
      back: "홈으로 돌아가기",
      backToList: "목록으로",
    },
    oss: { back: "홈으로 돌아가기" },
  ...
  en: {
    ...
    hero: {
      tagline: "TAP AND DRAG TO SHOOT",
      sub: "Bounce off walls, clear obstacles, and go for shots that look impossible!<br>Feel the thrill of pulling off the perfect Drag & Shot.",
      ctaPlay: "See Maps",
      ctaDownload: "Download",
    },
    features: {
      title: "A New Challenge Unfolds in Every Stage",
      desc: "Dozens of distinctive stages and a variety of obstacles await you.<br>Bring your creative plays to life and craft your own perfect Drag & Shot.",
    },
    gallery: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: "How do I earn points?", a: "Points can be earned in many ways. Landing a clean shot, throwing the ball with high power, or interacting with obstacles all give you bonus points. Try your best Drag & Shot to chase a high score." },
    ...
    download: {
      ...
      desc: "Download for free and take on Drag & Shot right now.",
    ...
    privacy: {
      ...
      subtitle: "Drag & Shot: Basketball Arcade treats your personal data with care.",
      back: "Back to home",
      updated: "Last updated: July 20, 2026",
      sections: [
        { h: "1. Overview", body: "<p>LaonPixels (the \"Developer\"), the developer of Drag & Shot: Basketball Arcade (the \"App\"), is committed to protecting user privacy. This policy explains how information is handled when you use the App.</p>" },
        { h: "2. Information we collect", body: "<p>Drag & Shot: Basketball Arcade collects only the minimum necessary information.</p><ul><li><strong>On-device storage:</strong> Stage progress, star ratings and game settings are stored locally on your device and are never sent to our servers.</li><li><strong>Advertising data:</strong> The App uses the Google AdMob advertising service. To serve and measure ads, information such as your advertising identifier, device ID, approximate location (based on IP address), device information, app usage and interaction data, and diagnostics (crash and performance data) may be collected and processed by Google and its advertising partners.</li><li><strong>Inquiry info (optional):</strong> Email address and message content when contacting support.</li></ul>" },
        { h: "3. How we use information", body: "<ul><li>Saving and restoring game progress</li><li>Fixing bugs and improving the App</li><li>Serving in-app ads and measuring ad performance</li><li>Responding to support inquiries</li></ul>" },
        { h: "4. Sharing & third parties", body: "<p>We do not sell your personal information. Your game progress data is stored locally on your device and is not sent to our servers.</p><p>However, the App uses Google AdMob to display ads. In doing so, the advertising data described in &#8220;Information we collect&#8221; above is provided to and processed by Google and its advertising partners. For details on how Google handles this data, see the link below.</p><ul><li>Google advertising &amp; privacy: <a href=\"https://policies.google.com/technologies/partner-sites\" target=\"_blank\" rel=\"noopener\">policies.google.com/technologies/partner-sites</a></li></ul>" },
        ...
        { h: "6. Children's privacy", body: "<p>The App is intended for users aged 13 and older. The Developer does not knowingly collect personal information from children under 13, and the App does not require account creation or personal information to play.</p><p>Because the App displays ads (Google AdMob), younger users are encouraged to use it under the guidance of a parent or guardian. If we become aware that we have collected personal information from a child under 13, we will delete it without delay.</p>" },
        ...
        { h: "9. Contact", body: "<p>For privacy inquiries, please reach us at:</p><p><strong>Developer:</strong> LaonPixels<br><strong>Email:</strong> laonpixels@gmail.com</p>" },
      ],
    },
    terms: {
      title: "Terms of Service",
      subtitle: "The terms that govern your use of Drag & Shot: Basketball Arcade.",
      back: "Back to home",
      updated: "Last updated: July 20, 2026",
      sections: [
        { h: "1. Purpose and acceptance", body: "<p>These Terms govern the rights, obligations, and responsibilities between LaonPixels (the \"Operator\") and users in connection with the use of the mobile game Drag & Shot: Basketball Arcade (the \"App\"). By downloading, installing, or using the App, you are deemed to have agreed to these Terms. If you do not agree, please stop using the App and delete it.</p>" },
        ...
        { h: "3. The service", body: "<p>Drag & Shot: Basketball Arcade is a physics-based, one-touch basketball Drag & Shot puzzle game. The Operator may add or change game content (stages, maps, features, and so on) to improve the quality of the service.</p>" },
    ...
    patch: {
      title: "Patch Notes",
      subtitle: "Catch up on the latest Drag & Shot updates.",
      back: "Back to home",
