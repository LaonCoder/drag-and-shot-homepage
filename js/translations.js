...
window.TS_I18N = {
  ...
  ko: {
    ...
    privacy: {
      title: "개인정보 처리방침",
      subtitle: "Drag & Shot이 어떤 정보를 수집하고 어떻게 사용하는지 안내합니다.",
      back: "홈으로 돌아가기",
      updated: "최종 수정일: 2026년 5월 31일",
      sections: [
        { h: "1. 개요", body: "<p>Drag & Shot 개발자(이하 &#8216;개발자&#8217;)는 이용자의 개인정보를 소중히 여기며 관련 법령을 준수합니다. 본 방침은 앱 이용 과정에서 개인정보가 어떻게 처리되는지 안내합니다.</p>" },
        { h: "2. 수집하는 정보", body: "<p>Drag & Shot은 최소한의 정보만을 수집합니다.</p><ul><li><strong>기기 저장 정보:</strong> 스테이지 클리어 여부, 별점 기록 등 게임 진행 상황은 기기 내부에만 저장되며 외부 서버로 전송되지 않습니다.</li><li><strong>문의 정보(선택):</strong> 고객 문의 시 이메일 주소 및 문의 내용</li></ul>" },
        ...
        { h: "6. 아동의 개인정보", body: "<p>Drag & Shot은 계정 시스템이 없고 개인정보 수집이 최소화되어 있어 아동도 안전하게 이용할 수 있습니다.</p>" },
    ...
    terms: {
      title: "이용약관",
      subtitle: "Drag & Shot 이용에 관한 약관입니다.",
      back: "홈으로 돌아가기",
      updated: "최종 수정일: 2026년 6월 15일",
      sections: [
        { h: "1. 목적 및 약관의 동의", body: "<p>본 약관은 LaonPixels(이하 &#8216;운영자&#8217;)가 제공하는 모바일 게임 Drag & Shot(이하 &#8216;앱&#8217;)의 이용과 관련하여 운영자와 이용자 간의 권리, 의무 및 책임 사항을 규정함을 목적으로 합니다. 이용자가 앱을 다운로드, 설치 또는 이용하는 경우 본 약관에 동의한 것으로 간주됩니다. 본 약관에 동의하지 않는 경우 앱의 이용을 중단하고 이를 삭제해 주시기 바랍니다.</p>" },
        ...
        { h: "3. 서비스의 내용", body: "<p>Drag & Shot은 물리 기반의 원터치 농구 Drag & Shot 퍼즐 게임입니다. 운영자는 서비스 품질 향상을 위하여 게임 콘텐츠(스테이지, 맵, 기능 등)를 추가하거나 변경할 수 있습니다.</p>" },
        ...
        { h: "7. 결제 및 환불", body: "<p>Drag & Shot은 현재 무료로 제공됩니다. 추후 인앱 결제 또는 유료 콘텐츠가 도입되는 경우, 결제·청약철회·환불은 전자상거래 등에서의 소비자보호에 관한 법률 등 관련 법령과 결제가 이루어진 앱 마켓(App Store, Google Play 등)의 환불 정책에 따릅니다.</p><p>관련 법령에 따라 보장되는 이용자의 청약철회 및 환불 권리는 본 약관에 의해 제한되지 않습니다.</p>" },
  ...
  en: {
    ...
    privacy: {
      ...
      subtitle: "Drag & Shot treats your personal data with care.",
      back: "Back to home",
      updated: "Last updated: May 31, 2026",
      sections: [
        { h: "1. Overview", body: "<p>The developer of Drag & Shot (the \"App\") is committed to protecting user privacy. This policy explains how information is handled when you use the App.</p>" },
        { h: "2. Information we collect", body: "<p>Drag & Shot collects only the minimum necessary information.</p><ul><li><strong>On-device storage:</strong> Stage progress, star ratings and game settings are stored locally on your device and are never sent to any external server.</li><li><strong>Inquiry info (optional):</strong> Email address and message content when contacting support.</li></ul>" },
        ...
        { h: "6. Children's privacy", body: "<p>Drag & Shot has no account system and collects minimal data, making it safe for players of all ages.</p>" },
    ...
    terms: {
      ...
      subtitle: "The terms that govern your use of Drag & Shot.",
      back: "Back to home",
      updated: "Last updated: June 15, 2026",
      sections: [
        { h: "1. Purpose and acceptance", body: "<p>These Terms govern the rights, obligations, and responsibilities between LaonPixels (the \"Operator\") and users in connection with the use of the mobile game Drag & Shot (the \"App\"). By downloading, installing, or using the App, you are deemed to have agreed to these Terms. If you do not agree, please stop using the App and delete it.</p>" },
        ...
        { h: "3. The service", body: "<p>Drag & Shot is a physics-based, one-touch basketball Drag & Shot puzzle game. The Operator may add or change game content (stages, maps, features, and so on) to improve the quality of the service.</p>" },
